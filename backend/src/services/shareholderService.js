...
export const addShareholder = async (shareholderData, incrementCount = true) => {
...
export const addMultipleShareholders = async (shareholders, companyId, incrementCount = true) => {
  const results = [];
