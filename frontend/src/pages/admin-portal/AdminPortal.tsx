...
import SelectedCompanyModal from "../../components/modals/selectedCompanyModal";
import { EditShareHoldersModal } from "../../components/modals/editShareHoldersModal";
import ShareholdersTable from "../../components/adminTable/ShareholdersTable";
import CompanyTable from "../../components/adminTable/CompanyTable";
  ...
  return (
    <div className={styles["admin-portal"]}>
      <div className={styles["admin-container"]}>
        ...
        <div className={styles["content-area"]}>
          ...
          {!loading && !error && activeTab === "company" && (
            <CompanyTable
              ...
              handleCompanyColumnSort={handleCompanyColumnSort}
              companyData={companyData}
              companySortOrder={companySortOrder}
              companySortColumn={companySortColumn}
          ...
          {!loading && !error && activeTab === "shareholders" && (
            <ShareholdersTable
              ...
              shareholderSortOrder={shareholderSortOrder}
              pageNumber={pageNumber}
              handleShareholderColumnSort={handleShareholderColumnSort}
              openEditShareholderModal={openEditShareholderModal}
              deleteShareholder={deleteShareholder}
              shareholderSortColumn={shareholderSortColumn}
            />
          )}
        </div>
        ...
        {editingShareholder && (
          <EditShareHoldersModal
            closeEditShareholderModal={closeEditShareholderModal}
